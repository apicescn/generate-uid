...
import com.xueying.seeker.uid.buffer.BufferPaddingExecutor;
import com.xueying.seeker.uid.buffer.RingBuffer;
import com.xueying.seeker.uid.BitsAllocator;
import com.xueying.seeker.uid.buffer.RejectedPutBufferHandler;
import com.xueying.seeker.uid.buffer.RejectedTakeBufferHandler;
 ...
 *                           threshold, it will trigger padding buffer.
 *                           Default as{@link RingBuffer#DEFAULT_PADDING_PERCENT}
 ...
 * @author tangyz
 */
@ConfigurationProperties(prefix = "seeker.uid.cached-uid-generator")
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    /** 拒绝策略: 当环已满, 无法继续填充时
     ...
     请实现RejectedPutBufferHandler接口(支持Lambda表达式)并以@Autowired方式注入 */
    ...
    /**
     * 构造类
     * @param uidGeneratorProperties Uid生成的配置参数
     */
    public CachedUidGenerator(UidGeneratorProperties uidGeneratorProperties) {
		super(uidGeneratorProperties);
	}
     ...
     * 
     * @param currentSecond currentSecond值
    ...
    protected List<Long> nextIdsForOneSecond(long currentSecond) {
        ...
        long firstSeqUid = bitsAllocator.allocate(currentSecond - uidGeneratorProperties.getEpochSeconds(),
                workerId, 0L);
     ...
     * @param boostPower RingBuffer size扩容参数
     */
