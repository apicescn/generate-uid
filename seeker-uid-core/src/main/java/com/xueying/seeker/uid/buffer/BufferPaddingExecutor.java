...
import static com.xueying.seeker.uid.contants.UIDContants.TWO_CONSTANT_INT;
...
public class BufferPaddingExecutor {
    ...
    public BufferPaddingExecutor(RingBuffer ringBuffer, BufferedUidProvider uidProvider, boolean usingSchedule) {
        ...
        bufferPadExecutors = new ThreadPoolExecutor(cores * TWO_CONSTANT_INT,
                cores * TWO_CONSTANT_INT, 0L, TimeUnit.MILLISECONDS,
